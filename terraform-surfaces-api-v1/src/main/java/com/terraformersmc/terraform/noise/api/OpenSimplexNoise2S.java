package com.terraformersmc.terraform.noise.api;

/**
 * K.jpg's OpenSimplex 2, smooth variant ("SuperSimplex")
 * <p>
 * This code kindly licensed by K.jpg under the CC0 license.
 * For more info, see <a href="https://github.com/KdotJPG/OpenSimplex2">K.jpg's OpenSimplex2 repo</a>.
 * </p>
 */
@SuppressWarnings({"NumericOverflow", "UnnecessaryLocalVariable", "unused"})
public class OpenSimplexNoise2S {
	...
	// BEGIN Terraformers additions (instance tracked seed)
	private static final long DEFAULT_SEED = 0L;

	private long seed = -1L;

	/**
	 * Create an instance of OpenSimplexNoise2 with the seed '0L'.
	 */
	...
	/**
	 * Create an instance of OpenSimplexNoise2 with the specified seed.
	 */
	...
	/**
	 * Delegates to {@code OpenSimplexNoise2.noise2(this.seed, x, y) }
	 * @param x double Axis 1 value
	 * @param y double Axis 2 value
	 * @return float Standard lattice orientation 2D noise value
	 */
	...
	/**
	 * Delegates to {@code OpenSimplexNoise2.noise3_ImproveXZ(this.seed, x, y, z) }
	 * @param x double Axis 1 value
	 * @param y double Axis 2 value
	 * @param z double Axis 3 value
	...
	/**
	 * @return long The seed used to create this noise generator instance
	 */
	public long getSeed() {
		return this.seed;
	}
	// END Terraformers additions
